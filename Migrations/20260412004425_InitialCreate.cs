        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectProposals_AspNetUsers_SubmittedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ExpressedInterestAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_SupervisorId_ProjectProposalId",
                table: "Matches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectProposals_SubmittedById",
                table: "ProjectProposals",
